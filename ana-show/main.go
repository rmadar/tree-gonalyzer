...
var (
	...
	var_dphi = &ana.Variable{
		...
		Value:      new(float64),
		TreeFunc:   ana.NewTreeFuncVarF64("truth_dphi_ll"),
		Nbins:      15,
		Xmin:       0,
		Xmax:       math.Pi,
	...
	var_Ckk = &ana.Variable{
		...
		TreeName:   "truth_Ckk",
		Value:      new(float64),
		TreeFunc:   ana.NewTreeFuncVarF64("truth_Ckk"),
		Nbins:      25,
		Xmin:       -1,
		Xmax:       1,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_Crr = &ana.Variable{
		...
		TreeName:   "truth_Crr",
		Value:      new(float64),
		TreeFunc:   ana.NewTreeFuncVarF64("truth_Crr"),
		Nbins:      25,
		Xmin:       -1,
		Xmax:       1,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_Cnn = &ana.Variable{
		...
		TreeName:   "truth_Cnn",
		Value:      new(float64),
		TreeFunc:   ana.NewTreeFuncVarF64("truth_Cnn"),
		Nbins:      25,
		Xmin:       -1,
		Xmax:       1,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_pt_lep = &ana.Variable{
		...
		TreeName:   "l_pt",
		Value:      new(float32),
		TreeFunc:   ana.NewTreeFuncVarF32("l_pt"),
		Nbins:      25,
		Xmin:       0,
		Xmax:       500,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_eta_lep = &ana.Variable{
		...
		TreeName:   "l_eta",
		Value:      new(float32),
		TreeFunc:   ana.NewTreeFuncVarF32("l_eta"),
		Nbins:      25,
		Xmin:       -5,
		Xmax:       5,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_pt_b = &ana.Variable{
		...
		TreeName:   "b_pt",
		Value:      new(float32),
		TreeFunc:   ana.NewTreeFuncVarF32("b_pt"),
		Nbins:      25,
		Xmin:       0,
		Xmax:       500,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_eta_b = &ana.Variable{
		...
		TreeName:   "b_eta",
		Value:      new(float32),
		TreeFunc:   ana.NewTreeFuncVarF32("b_eta"),
		Nbins:      25,
		Xmin:       -5,
		Xmax:       5,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_pt_vsum = &ana.Variable{
		...
		TreeName:    "vsum_pt",
		Value:       new(float32),
		TreeFunc:    ana.NewTreeFuncVarF32("vsum_pt"),
		Nbins:       25,
		Xmin:        0,
		Xmax:        250,
		PlotTitle:   `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_pt_t = &ana.Variable{
		...
		TreeName:  "t_pt",
		Value:     new(float32),
		TreeFunc:  ana.NewTreeFuncVarF32("t_pt"),
		Nbins:     100,
		Xmin:      0,
		Xmax:      500,
		PlotTitle: `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
	...
	var_pt_tt = &ana.Variable{
		...
		TreeName:   "ttbar_pt",
		Value:      new(float32),
		TreeFunc:   ana.NewTreeFuncVarF32("ttbar_pt"),
		Nbins:      25,
		Xmin:       0,
		Xmax:       150,
		PlotTitle:  `{\tt TTree} {\bf GO}nalyzer -- $pp \to t\bar{t}$ @ $13\,$ TeV`,
